    ...
    <section className="py-20">
      <div className="mb-12 text-center">
        <div className="mb-4 inline-flex items-center gap-2.5 rounded-full bg-red-50/50 px-4 py-2">
          ...
          <span className="text-sm font-light tracking-widest text-red-400 uppercase">
            Pinterest
          </span>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        {pinterestPins.map((pin, i) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 flex items-end justify-center bg-linear-to-t from-black/40 via-transparent to-transparent pb-6 opacity-0 transition-opacity duration-500 group-hover:opacity-100">
    ...
    <section className="py-20">
      <div className="mb-12 text-center">
        <div className="mb-4 inline-flex items-center gap-2.5 rounded-full bg-pink-50/50 px-4 py-2">
          ...
          <span className="text-sm font-light tracking-widest text-pink-400 uppercase">
            Instagram
          </span>
        </div>
        ...
        {instagramPosts.map((post, i) => (
          ...
          >
            <Image
              ...
              className="object-cover transition-transform duration-700 ease-out group-hover:scale-110"
            />
            <div className="absolute inset-0 flex items-center justify-center bg-linear-to-t from-black/40 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
